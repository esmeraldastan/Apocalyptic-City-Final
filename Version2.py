...
def newWindow():
    ...
    canvas = Tkinter.Canvas(root1, height = 100, width = 990, relief = Tkinter.RAISED, bg= 'black')
    canvas.grid()
    canvas2 = Tkinter.Canvas(root1, height = 390, width = 990, relief = Tkinter.RAISED, bg = 'red')
    canvas2.grid()
    ...
    button = Tkinter.Button(root1, text= 'North', width = 10, height = 5, command = con_room)
    button.grid(row = 1, column= 4)
    
    button = Tkinter.Button(root1, text= 'East', width = 10, height = 5, command = desk)
    button.grid(row = 1, column= 5)

    button = Tkinter.Button(root1, text= 'South', width = 10, height = 5, command = wrong_way)
    button.grid(row = 3, column= 4)

    button = Tkinter.Button(root1, text= 'West', width = 10, height = 5, command = wrong_way)
    button.grid(row = 3, column= 5)

    button = Tkinter.Button(root1, text= 'QUIT', width = 10, height = 5, command = root1.destroy)
...
def con_room():    
    ...
    editor = Tkinter.Text(master = root2, width= 45, height = 0)
    ...
    button = Tkinter.Button(root2, text= 'North', width = 10, height = 5, command = newWindow3)
    button.grid(row = 0, column= 5)
    
    button = Tkinter.Button(root2, text= 'East', width = 10, height = 5, command = elevator)
    button.grid(row = 0, column= 5)

    button = Tkinter.Button(root2, text= 'South', width = 10, height = 5, command = newWindow3)
    button.grid(row = 3, column= 4)
